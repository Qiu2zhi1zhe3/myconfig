...
install_XrayR() {
    ...
    if [[ ! -f /etc/XrayR/config.yml ]]; then
        curl -o /etc/XrayR/config.yml -Ls https://raw.githubusercontent.com/Qiu2zhi1zhe3/myconfig/main/XrayR/config.yml
        echo -e ""
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/Qiu2zhi1zhe3/myconfig/main/XrayR/XrayR.sh
